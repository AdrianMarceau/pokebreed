...
(function(){
    ...
    thisIndex.addSpeciesIndex({
        ...
        'poipole': {
            ...
            types: ['poison'],
            genderRatio: {none: 1.0000},
            baseStats: {hp: 67, phAttack: 73, phDefense: 67, spAttack: 73, spDefense: 67, speed: 73},
            abilities: {0: 'beast-boost'},
            height: 0.6,
            weight: 1.8,
            colors: ['purple', 'pink', 'gray', 'blue'],
            evos: ['naganadel'],
            eggCycles: 120,
            eggGroups: ['undiscovered'],
            nextEvolutions: [{
        ...
        'naganadel': {
            ...
            types: ['poison', 'dragon'],
            genderRatio: {none: 1.0000},
            baseStats: {hp: 73, phAttack: 73, phDefense: 73, spAttack: 127, spDefense: 73, speed: 121},
            abilities: {0: 'beast-boost'},
            height: 3.6,
            weight: 150,
            colors: ['purple', 'gray', 'pink', 'blue'],
            eggCycles: 120,
            eggGroups: ['undiscovered'],
