            ...
            <div class="buttons">
                ...
                <div class="filter-pokemon hidden" data-target="buttons">
                    <div class="wrap">
                        ...
                        <div class="more">
                            <a class="button add-ditto" title="Add a Ditto"><span>Add Ditto</span></a>
                ...
                <div class="info links">
                    ...
                    <a class="link" data-tab="modes">modes</a>
                ...
                <div class="info hidden" data-tab="modes">
                    <? require('pages/modes.php'); ?>
                </div>
