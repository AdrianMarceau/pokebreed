...
<html>
    <head>
        <meta charset="utf8">
        <title>Pokémon Breeding Simulator v<?= $version_number ?></title>
        ...
        <div class="panel">
            ...
            <div class="overview main">
                ...
                <div class="details zone">
                    <strong class="title">Zone Details</strong>
                    <div class="timer">
                        <div class="total">
